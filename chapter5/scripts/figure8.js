...
(function() {
		...
		state = {
			...
			items: [
				...
				},
				{
					...
					{ id: 'rule2dim', property: ['style','visible'], yes: true, no: false}]
				},
				{
					type: 'control',
					controlType: 'checkbox',
	...
	new p5(makeP5App(state, fig8actions), 'figure8img')
	
	popout.openButton('Figure8')
	popout.addhelp('Figure8', fig8actions.toggle)
